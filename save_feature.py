# -*- coding: utf-8 -*-
"""
Created on Fri Jul  5 09:25:26 2019
...
person_name_list = []
for person in person_list:
    #person_name_list.append(str(person.split('_')[0]))
...
with open("data/features_all.csv", "w", newline="") as csvfile:
    ...
    for person in range(person_cnt):
        ...
        print(path_images_from_camera + str(person_name_list[person]))
        features_mean_personX = return_features_mean_personX(path_images_from_camera + str(person_name_list[person]))
